...
import FlashCard from './FlashCardComponent/FlashCards';
import Header from './FlashCardComponent/Header';
import FlashcardApp from './FlashCardComponent/Deck';
        ...
        <section className="flex flex-row h-screen w-full ">
            <section className="h-full w-[15%] bg-[#F4F4F5] border-r border-r-[#E4E4E7]">
                ...
                <section  className="h-[95%] flex flex-col gap-2 py-[10px] w-[100%] cursor-pointer text-[14px] text-[#9DACA5] font-semibold">
                    ...
                    <section style={currentTab === "Roadmaps" ? activeStyle : {}} onClick={() => {setCurrentTab("Roadmaps")}} className='flex gap-4 items-center py-[10px] rounded-sm hover:bg-[#E7E7E8] w-[100%] px-[30px]  hover:text-[#1B181F] '><img src={terminal} alt="playground" className='h-[28px]' />Roadmaps</section>
                </section>
            </section>
            <section className="flex flex-col h-full w-[85%] bg-white">
                ...
                <section className="w-full h-[94%] px-[30px] bg-white">
                    ...
                    <>
                        ...
                        {/* *** user playground data *** uncomment later on */}
