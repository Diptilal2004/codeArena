...
const Ai = () => {
    ...
    function  handleSubmit (event : any ) {
        ...
        const deck_id = formData.get("deck_id");
    ...
    return(
        ...
        <section className="w-[100%]">
            <Header />
            <section className="m-[20px] mt-[100px] w-[100%] flex flex-col items-center justify-center ">
                <section className="min-w-[150px] flex flex-col items-center justify-center gap-10 w-[100%]" onClick={() => {
                    ...
                    <input type="number" name="deck_id" id="deck_id" className="p-[10px] rounded-md" placeholder="Enter deck id eg.7" required/> 
