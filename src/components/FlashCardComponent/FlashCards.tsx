...
export const FlashCard = () => {
    ...
    useEffect(() => {
        if(user){
            axios.get(`${api}/card/?deck_id=${deck_id}`)
            .then((response : any) => {
    ...
    return (
        <section className="card-area flex flex-col items-center justify-center">
                <Header />
                <>
                <section className=" mt-[100px] card-head max-[390px]:box-border max-[390px]:ml-[20px] flex gap-3 m-[30px] w-[40%] border border-gray-300 p-[20px] pr-[0] rounded-lg justify-center min-w-[740px] md:max-w-[300px] ml-[100px]">
                ...
                <section className=" ml-[100px] card-foot max-[390px]:ml-[20px] flex items-center justify-between w-[40%] m-[30px] min-w-[740px]">
